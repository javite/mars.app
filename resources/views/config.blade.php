...
<form  id="program-form" class="form col" >
    ...
    <div class="container-fluid">
                <label class="label" for="actions">Accion</label>
                <br>
    ...
    <div class="form-group">
        <label for="event_id" class="form-control">Evento ID</label>
        <input type="text" name="event_id" value="1">
    </div>
    <div class="form-group">
        <label for="event" class="form-control">evento</label>
        <input type="text" name="event" value="La planta crecio mucho">
    </div>
    <!-- <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="comment" value="esta es una planta loca">
    </div> -->
    <!-- <div class="form-group">
