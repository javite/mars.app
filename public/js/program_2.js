import ProgramBundle from "./program-bundle.js";
...
$(document).ready(function(){
    ...
    $('#program-container').append('<button id="create">create</button>');
    $('#program-container').append('<button id="update">update</button>');
    $('#program-container').append('<button id="hide">hide</button>');
    $('#program-container').append('<button id="show">show</button>');
    $('#create').on('click', function(){
        program_bundle = new ProgramBundle();
    });
     
    $('#update').on('click', function(){
        program_bundle.update(options);
    });
...
function getPrograms(prog_selected){
    fetch('api/getProgram.php?device_id=' + device_id) //todos los programas
    .then(data =>data.json())
    .then(data => {
        programs = data;
        console.log(data);
